...
#
# Usage:
#   bind-key -T <table> ? run-shell '"$TYPHON_SCRIPTS/help.sh" <table>'
...
# Globals:
#   XDG_CONFIG_HOME, XDG_DATA_HOME, TYPHON_SCRIPTS, HOME
# Arguments:
#   name - key table name
# Outputs:
...
find_help_file() {
  ...
  for dir in \
    ...
    "${XDG_DATA_HOME:-${HOME}/.local/share}/tmux/typhon-help" \
    "${TYPHON_SCRIPTS}/../typhon-help"; do
